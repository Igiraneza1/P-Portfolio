...
function About() {
  return (
    <section className="p-6 sm:p-10 bg-white text-gray-800">
      <h1 className="text-4xl sm:text-5xl font-bold text-center mb-10 text-blue-900">About Me</h1>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
        {/* Vision */}
        <article className="border-l-4 border-b-4 border-gray-300 p-6 shadow-lg bg-cyan-50 rounded-lg transition-transform hover:scale-[1.01]">
          <figure>
            <img
        ...
        {/* Mission */}
        <article className="border-r-4 border-t-4 border-gray-300 p-6 shadow-lg bg-blue-50 rounded-lg transition-transform hover:scale-[1.01]">
          <figure>
            <img
              className="rounded-xl w-full h-64 object-cover opacity-90 mb-4"
              src={mission}
